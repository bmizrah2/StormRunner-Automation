...
public class StormRunnerResultsPage extends AbstractPage {
	...
	// Clicking on Single User Performance tab
	...
	//Inserting inside inner HTML ('Client Side Breakdown' Tab)
	...
	// Click on 'x' to remove transaction widget from dashboard
	...
	public Boolean isGoTo2ndPageTransExistInDashboard() throws Exception{
		return bot.isElementDisplayed1(transactionGoTo2ndPageWidget);
	}


	// Is 2nd transaction exist in dashboard
	public Boolean isBackHomeTransExistInDashboard() throws Exception{
